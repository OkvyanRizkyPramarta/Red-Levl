							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2 style="color:white;">Form Edit Gallery Picture</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int float-lb floating-lb">
                                    ...
                                    <div class="nk-int-st">
                                        <label>Picture Galley</label>
                                        <input type="file" class="form-control" name="image" value="{{ $image->image }}">
                                        <img width="250px" src="{{asset('storage/'.$image->image)}}">
                                    </div>
                                </div>
                            </div>
                        </div>
