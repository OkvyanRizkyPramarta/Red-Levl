                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2 style="color:white;"><span class="counter">10</span></h2>
                            <p style="color:white;">Total Service</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2 style="color:white;"><span class="counter">150</span></h2>
                            <p style="color:white;">Total Blog</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2 style="color:white;"><span class="counter">15</span></h2>
                            <p style="color:white;">Total Cooperation</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="sale-statistic-area">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="recent-post-wrapper notika-shadow mg-tb-30 sm-res-mg-t-30 tb-res-ds-n dk-res-ds">
