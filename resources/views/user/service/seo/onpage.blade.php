        ...
        <div class="container pt-5 pb-3">
            <div class="row">
                <div class="col-lg-6 mb-2">
                    <div>
                        <img class="" height="300px;" width="500px;" src="{{ asset('user/img/on-page.png') }}" alt="">
                    </div>
                    <p style="color:white;">On Page SEO<br>
                    <a href="{{url ('/service/seo/onpage/detail') }}" target="_blank" rel="noopener noreferrer">
                        Read More
                    </a>
                    </p>   
                </div>
